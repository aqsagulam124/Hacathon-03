  ...
  return (
    <>
      ...
      <div className="w-full h-[600px] bg-[#FBEBB5] flex items-center relative flex-col lg:flex-row">
        {/* Text Section */}
        <div className="text-center lg:text-left lg:absolute lg:left-[80px] w-full px-4 lg:px-0">
        ...
        {/* Image Section */}
          <div className="w-full lg:w-[700px] flex justify-center mt-6 lg:mt-0 lg:absolute lg:right-[1px]">
          <Image
            src="/headersofa.png"
